...
describe('Pubsub hook', function () {
  describe('loading a Choreo app', function () {
      ...
      it('should fail', function (done) {
        app.load({
          ...
          return done(new Error(
            'Should have failed to load the pubsub hook w/o the `orm` hook.'
          ));
        });
      });
    });
    ...
    describe('without sockets hook', function () {
      ...
      it('should fail', function (done) {
        app.load({
          ...
          if (err) return done();
          return done(new Error(
            'Should have failed to load the pubsub hook w/o the `sockets` hook.'
          ));
        });
      });
    });
    ...
    describe('without http hook', function () {
      ...
      it('should fail', function (done) {
        app.load({
          ...
          if (err) return done();
          return done(new Error(
            'Should have failed to load the pubsub hook w/o the `http` hook.'
          ));
        });
      });
    });
