...
describe('Request hook', function () {
  describe('metadata', function () {
    ...
    describe('without a reverse proxy', function () {
      ...
      it('should not add a port to baseUrl on port 80 or 443',
        function () {
          this.req.protocol = 'http';
          this.req.host = 'example.org';
          this.req.headers.Host = 'example.org';
    ...
    describe('with a reverse proxy and app.enable("trust proxy")',
      function () {
        beforeEach(function () {
        ...
        it('should handle a simple HTTP case with X-Forwarded-Host',
          function () {
        ...
        it('should handle when X-Forwarded-Host is not set',
          function () {
            this.req.protocol = 'http'; // we assume Express got this right
            this.req.host = 'server.local';
        ...
        it('should handle a simple HTTPS case with X-Forwarded-Host',
          function () {
        ...
        it(
          'should handle running on a weird port through a reverse proxy',
          function () {
            this.req.protocol = 'http';
            this.req.host = 'server.local';
