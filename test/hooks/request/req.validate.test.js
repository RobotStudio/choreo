  ...
  describe('req.validate()', function () {
    ...
    it(
      ...
      function (done) {
        ...
        choreo.request(ROUTEADDRESS + '?foo=hi', done);
      });

    it(
      'should throw E_INVALID_PARAMS when required params are missing',
      function (done) {
        ...
        choreo.request(ROUTEADDRESS + '?foo=hi');
      });
