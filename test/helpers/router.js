...
var $Router = {
  ...
  unbind: function (route) {
    ...
    it('binds the given route', function () {
      this.choreo.router.bind.should.be.ok;
      this.choreo.router.bind.apply(this.choreo.router, args);
    });

    var Chainable = {
      shouldDelete: function (expected) {
        it('should delete route in _privateRouter', function () {
          var boundRoutes = this.choreo.router._privateRouter.routes[
            expected.method];
          _.some(boundRoutes, expected)
            .should.be.false;
        });
  ...
  bind: function (route, handler) {
    ...
    var Chainable = {
      expectBoundRoute: function (expected) {
        ...
        it('should create ' + readableRoute +
          ' in _privateRouter router',
          function () {
            var boundRoutes = this.choreo.router._privateRouter.routes[
              expected.method];
            _.some(boundRoutes, expected)
...
//  /**
//   * Send a mock request to the instance of Choreo in the test context.
//   *
...
//      this.choreo.emit('router:request', _req(), _res(), _fakeClient);
//    };
//  },
...
// /**
//  * Test fixture to send requests to Choreo.
//  *
//  * @api private
//  */
...
// /**
//  * Test fixture to receive responses from Choreo.
//  *
//  * @api private
//  */
