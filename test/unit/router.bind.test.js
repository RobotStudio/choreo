...
describe('Router.bind', function () {
  ...
  $Router.bind('get /foo', RESPOND.HELLO)
    ...
    .test(function () {
      it('should send expected response (get /foo)', function (done) {
        supertest(this.choreo.router._privateRouter)
          .get('/foo')
  ...
  $Router.bind('post /bar_baz_beezzz', RESPOND.HELLO_500)
    ...
    .test(function () {
      it('should send expected response (post /bar_baz_beezzz)',
        function (done) {
          supertest(this.choreo.router._privateRouter)
            .post('/bar_baz_beezzz')
  ...
  $Router.bind('post /something_that_throws', RESPOND.SOMETHING_THAT_THROWS)
    .test(function () {
      it('should respond with 500 handler if something throws', function (
        done) {
        supertest(this.choreo.router._privateRouter)
