 ...
 * `choreo deploy`
 *
 * Deploy the Choreo app in the current directory to a hosting provider.
 *
 * @stability 1
 */
...
module.exports = function () {
  ...
  if (!modulePath) {
    ...
    console.error(
      "To use `choreo deploy`, set a `commands.deploy.module` setting in your .choreorc file"
    );
    return;
  }
  ...
  // If the module couldn't be required, bail out
    ...
    console.error("Could not require module at path: " + modulePath +
