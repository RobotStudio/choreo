 ...
 *
 * @stability 2
 * @see http://choreojs.org/documentation/reference/command-line-interface/choreo-generate
 */
...
module.exports = function () {
  ...
  var scope = {
    ...
    choreoRoot: path.resolve(__dirname, '..'),
    modules: {},
  ...
  if (!scope.generatorType) {
    return cb.log.error('Usage: choreo generate [something]');
  }
