...
func (BatteryState_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor22, []int{0, 0} }
...
func (BatteryState_Health) EnumDescriptor() ([]byte, []int) { return fileDescriptor22, []int{0, 1} }
...
func (BatteryState_Technology) EnumDescriptor() ([]byte, []int) { return fileDescriptor22, []int{0, 2} }
...
type BatteryState struct {
	...
	Voltage               *Float32                `protobuf:"bytes,5,opt,name=voltage" json:"voltage,omitempty"`
	Current               *Float32                `protobuf:"bytes,6,opt,name=current" json:"current,omitempty"`
	Charge                *Float32                `protobuf:"bytes,7,opt,name=charge" json:"charge,omitempty"`
	Capacity              *Float32                `protobuf:"bytes,8,opt,name=capacity" json:"capacity,omitempty"`
	DesignCapacity        *Float32                `protobuf:"bytes,9,opt,name=design_capacity,json=designCapacity" json:"design_capacity,omitempty"`
	Percentage            *Float32                `protobuf:"bytes,10,opt,name=percentage" json:"percentage,omitempty"`
	PowerSupplyStatus     *UInt32                 `protobuf:"bytes,12,opt,name=power_supply_status,json=powerSupplyStatus" json:"power_supply_status,omitempty"`
	PowerSupplyHealth     *UInt32                 `protobuf:"bytes,13,opt,name=power_supply_health,json=powerSupplyHealth" json:"power_supply_health,omitempty"`
	PowerSupplyTechnology *UInt32                 `protobuf:"bytes,14,opt,name=power_supply_technology,json=powerSupplyTechnology" json:"power_supply_technology,omitempty"`
	Present               *Bool                   `protobuf:"bytes,15,opt,name=present" json:"present,omitempty"`
	CellVoltage           *Float32                `protobuf:"bytes,16,opt,name=cell_voltage,json=cellVoltage" json:"cell_voltage,omitempty"`
	Location              *String                 `protobuf:"bytes,17,opt,name=location" json:"location,omitempty"`
	SerialNumber          *String                 `protobuf:"bytes,18,opt,name=serial_number,json=serialNumber" json:"serial_number,omitempty"`
}
...
func (*BatteryState) Descriptor() ([]byte, []int) { return fileDescriptor22, []int{0} }
...
func (m *BatteryState) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *BatteryState) GetCurrent() *Float32 {
	if m != nil {
		return m.Current
	}
	return nil
...
func (m *BatteryState) GetCharge() *Float32 {
	if m != nil {
		return m.Charge
	}
	return nil
...
func (m *BatteryState) GetCapacity() *Float32 {
	if m != nil {
		return m.Capacity
	}
	return nil
...
func (m *BatteryState) GetDesignCapacity() *Float32 {
	if m != nil {
...
func (m *BatteryState) GetPercentage() *Float32 {
	if m != nil {
		return m.Percentage
	}
	return nil
...
func (m *BatteryState) GetPowerSupplyStatus() *UInt32 {
	if m != nil {
...
func (m *BatteryState) GetPowerSupplyHealth() *UInt32 {
	if m != nil {
...
func (m *BatteryState) GetPowerSupplyTechnology() *UInt32 {
	if m != nil {
...
func (m *BatteryState) GetPresent() *Bool {
	if m != nil {
		return m.Present
	}
	return nil
...
func (m *BatteryState) GetCellVoltage() *Float32 {
	if m != nil {
...
func (m *BatteryState) GetLocation() *String {
	if m != nil {
		return m.Location
	}
	return nil
...
func (m *BatteryState) GetSerialNumber() *String {
	if m != nil {
...
func init() { proto.RegisterFile("sensor/battery.proto", fileDescriptor22) }
