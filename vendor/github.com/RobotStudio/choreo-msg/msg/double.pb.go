...
func (*DoubleArray) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func (*Double) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{1} }
...
func init() { proto.RegisterFile("primitive/double.proto", fileDescriptor15) }
