...
func (NavSatStatus_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{2, 0} }
...
func (NavSatStatus_Service) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{2, 1} }
...
type IMU struct {
	...
	OrientationCovariance        []*Float64  `protobuf:"bytes,3,rep,name=orientation_covariance,json=orientationCovariance" json:"orientation_covariance,omitempty"`
	AngularVelocity              *Vector3    `protobuf:"bytes,4,opt,name=angular_velocity,json=angularVelocity" json:"angular_velocity,omitempty"`
	AngularVelocityCovariance    []*Float64  `protobuf:"bytes,5,rep,name=angular_velocity_covariance,json=angularVelocityCovariance" json:"angular_velocity_covariance,omitempty"`
	LinearAcceleration           *Vector3    `protobuf:"bytes,6,opt,name=linear_acceleration,json=linearAcceleration" json:"linear_acceleration,omitempty"`
	LinearAccelerationCovariance []*Float64  `protobuf:"bytes,7,rep,name=linear_acceleration_covariance,json=linearAccelerationCovariance" json:"linear_acceleration_covariance,omitempty"`
}

func (m *IMU) Reset()                    { *m = IMU{} }
func (m *IMU) String() string            { return proto.CompactTextString(m) }
func (*IMU) ProtoMessage()               {}
func (*IMU) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{0} }

func (m *IMU) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *IMU) GetOrientationCovariance() []*Float64 {
	if m != nil {
...
func (m *IMU) GetAngularVelocity() *Vector3 {
	if m != nil {
...
func (m *IMU) GetAngularVelocityCovariance() []*Float64 {
	if m != nil {
...
func (m *IMU) GetLinearAcceleration() *Vector3 {
	if m != nil {
...
func (m *IMU) GetLinearAccelerationCovariance() []*Float64 {
	if m != nil {
...
type MagneticField struct {
	Header                  *Header    `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	MagneticField           *Vector3   `protobuf:"bytes,2,opt,name=magnetic_field,json=magneticField" json:"magnetic_field,omitempty"`
	MagneticFieldCovariance []*Float64 `protobuf:"bytes,3,rep,name=magnetic_field_covariance,json=magneticFieldCovariance" json:"magnetic_field_covariance,omitempty"`
}
...
func (*MagneticField) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{1} }

func (m *MagneticField) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *MagneticField) GetMagneticField() *Vector3 {
	if m != nil {
...
func (m *MagneticField) GetMagneticFieldCovariance() []*Float64 {
	if m != nil {
...
func (*NavSatStatus) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{2} }
...
type NavSatFix struct {
	...
	Latitude               *Float64                         `protobuf:"bytes,3,opt,name=latitude" json:"latitude,omitempty"`
	Longitude              *Float64                         `protobuf:"bytes,4,opt,name=longitude" json:"longitude,omitempty"`
	Altitude               *Float64                         `protobuf:"bytes,5,opt,name=altitude" json:"altitude,omitempty"`
	PositionCovariance     []*Float64                       `protobuf:"bytes,6,rep,name=position_covariance,json=positionCovariance" json:"position_covariance,omitempty"`
...
func (*NavSatFix) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{3} }

func (m *NavSatFix) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *NavSatFix) GetLatitude() *Float64 {
	if m != nil {
		return m.Latitude
	}
	return nil
...
func (m *NavSatFix) GetLongitude() *Float64 {
	if m != nil {
		return m.Longitude
	}
	return nil
...
func (m *NavSatFix) GetAltitude() *Float64 {
	if m != nil {
		return m.Altitude
	}
	return nil
...
func (m *NavSatFix) GetPositionCovariance() []*Float64 {
	if m != nil {
...
func init() { proto.RegisterFile("sensor/imu.proto", fileDescriptor25) }
