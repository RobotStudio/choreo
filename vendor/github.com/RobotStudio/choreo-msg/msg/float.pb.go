...
func (*FloatArray) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{0} }
...
func (*Float) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{1} }
...
func (*Float32Array) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{2} }
...
func (*Float32) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{3} }
...
func (*Float64Array) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{4} }
...
func (*Float64) Descriptor() ([]byte, []int) { return fileDescriptor17, []int{5} }
...
func init() { proto.RegisterFile("primitive/float.proto", fileDescriptor17) }
