...
func (*Vector3Stamped) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }

func (m *Vector3Stamped) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (*Vector3) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func init() { proto.RegisterFile("geometric/vector.proto", fileDescriptor10) }
