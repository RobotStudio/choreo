...
func (*Point32Stamped) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }

func (m *Point32Stamped) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
func (*PointStamped) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }

func (m *PointStamped) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type Point32 struct {
	X *Float32 `protobuf:"bytes,1,opt,name=x" json:"x,omitempty"`
	Y *Float32 `protobuf:"bytes,2,opt,name=y" json:"y,omitempty"`
	Z *Float32 `protobuf:"bytes,3,opt,name=z" json:"z,omitempty"`
}

func (m *Point32) Reset()                    { *m = Point32{} }
func (m *Point32) String() string            { return proto.CompactTextString(m) }
func (*Point32) ProtoMessage()               {}
func (*Point32) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }

func (m *Point32) GetX() *Float32 {
	if m != nil {
		return m.X
	}
	return nil
...
type Point struct {
	...
	Z *Float64 `protobuf:"bytes,3,opt,name=z" json:"z,omitempty"`
}

func (m *Point) Reset()                    { *m = Point{} }
func (m *Point) String() string            { return proto.CompactTextString(m) }
func (*Point) ProtoMessage()               {}
func (*Point) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func init() { proto.RegisterFile("geometric/point.proto", fileDescriptor4) }
