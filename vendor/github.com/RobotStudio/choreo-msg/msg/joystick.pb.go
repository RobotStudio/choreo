...
func (JoyFeedback_FeedbackType) EnumDescriptor() ([]byte, []int) { return fileDescriptor27, []int{1, 0} }

type Joy struct {
	Header  *Header    `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	Axes    []*Float32 `protobuf:"bytes,2,rep,name=axes" json:"axes,omitempty"`
	Buttons []*Int32   `protobuf:"bytes,3,rep,name=buttons" json:"buttons,omitempty"`
}

func (m *Joy) Reset()                    { *m = Joy{} }
func (m *Joy) String() string            { return proto.CompactTextString(m) }
func (*Joy) ProtoMessage()               {}
func (*Joy) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{0} }

func (m *Joy) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type JoyFeedback struct {
	...
	Id        *UInt32                  `protobuf:"bytes,2,opt,name=id" json:"id,omitempty"`
	Intensity *Float32                 `protobuf:"bytes,3,opt,name=intensity" json:"intensity,omitempty"`
}
...
func (*JoyFeedback) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{1} }
...
func (m *JoyFeedback) GetId() *UInt32 {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *JoyFeedback) GetIntensity() *Float32 {
	if m != nil {
		return m.Intensity
	}
	return nil
...
func (*JoyFeedbackArray) Descriptor() ([]byte, []int) { return fileDescriptor27, []int{2} }
...
func init() { proto.RegisterFile("sensor/joystick.proto", fileDescriptor27) }
