...
type DiagnosticStatus struct {
	...
	HardwareId *String                `protobuf:"bytes,4,opt,name=hardware_id,json=hardwareId" json:"hardware_id,omitempty"`
...
func (m *DiagnosticStatus) GetName() *String {
	if m != nil {
		return m.Name
	}
	return nil
...
func (m *DiagnosticStatus) GetMessage() *String {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *DiagnosticStatus) GetHardwareId() *String {
	if m != nil {
		return m.HardwareId
	}
	return nil
...
func (m *DiagnosticArray) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type ServiceResponse struct {
	Header  *Header `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	Success *Bool   `protobuf:"bytes,2,opt,name=success" json:"success,omitempty"`
	Message *String `protobuf:"bytes,3,opt,name=message" json:"message,omitempty"`
}
...
func (m *ServiceResponse) GetHeader() *Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type ServiceSelfTest struct {
	...
	Passed *Bool               `protobuf:"bytes,2,opt,name=passed" json:"passed,omitempty"`
...
func (m *ServiceSelfTest) GetId() *String {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *ServiceSelfTest) GetPassed() *Bool {
	if m != nil {
		return m.Passed
	}
	return nil
