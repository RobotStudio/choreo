...
func (*BoolArray) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func (*Bool) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{1} }
...
func init() { proto.RegisterFile("primitive/bool.proto", fileDescriptor13) }
