...
//
// TODO
// Pull this into a separate module, since it's not specific to Choreo.
//
 ...
 * Otherwise bind a normal one-time event using
 * `EventEmitter.prototype.once()`.  Useful for checking whether or not
 * something has finished loading, etc.
 *
...
module.exports = function mixinAfter(emitter) {
   ...
   * `emitter.after()`
   *
   * Fires your handler **IF THE SPECIFIED EVENT HAS ALREADY BEEN TRIGGERED**
